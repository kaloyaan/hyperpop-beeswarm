...
d3.select("#popColor").style("color", colors("pop"));
d3.select("#hyperpopColor").style("color", colors("hyperpop"));
...
d3.csv("pop-vs-hyperpop-small.csv").then(function (data) {
    ...
    function redraw() {
        ...
        let countriesCircles = svg.selectAll(".countries")
            .data(dataSet, function(d) { return d.Song });
        ...
        d3.selectAll(".countries").on("mousemove", function(d) {
            tooltip.html(`Song: <strong>${d.Song}</strong><br>
